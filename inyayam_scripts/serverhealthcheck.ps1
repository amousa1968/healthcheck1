...
$computername = computername | Out-Host
...
$Outputreport | out-file C:\inyayam_scripts\powershell\Scripts\Server_Health_Status.html 
Invoke-Expression C:\inyayam_scripts\powershell\Scripts\Server_Health_Status.html
